...
document.querySelector('#change-me-button').onclick = function() {
    document.querySelector('#change-me-title').innerHTML = 'Hello! My Name is William!'
  }
  ...
  */
  ...
  document.querySelector('#delete-me-button').onclick = function() {
    ...
    id = '.delete-me-title';
    var original = document.querySelector('.delete-me-title');
    original.removeChild(original.childNodes[0]); 
